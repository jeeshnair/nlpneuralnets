...
def _parse_args():
    ...
    parser.add_argument('--model', type=str, default='PERCEPTRON', choices=('TRIVIAL', 'PERCEPTRON', 'FNN', 'RNN', 'MyNN'), help='model to run')
    ...
    parser.add_argument('--epoch', type=int, default=40, help='epochs to train for')
